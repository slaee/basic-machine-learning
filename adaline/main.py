...
from ml.Adaline import Adaline
from ml.ImageDataset import ImageDataset

root = Tk()
root.title("Vowel Recognition With Adaline")
...
test_acc = adaline.evaluate(imgDataSets.dataX(), imgDataSets.labelY()) 
